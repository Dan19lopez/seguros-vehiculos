...
export default function BuscarPorId({funcionParaEditar, funcionParaEliminar}) {
    ...
    const [inputValue, setInputValue] = useState("")
      ...
      return (
        <>
          <form onSubmit={handleSearch} className="space-y-4 bg-color1 border border-blue-50 p-4 rounded shadow-lg">
            <input
              type="text"
              name="id"
            ...
            <table className="w-full bg-color1 table-auto text-sm">
              ...
              <tbody>
                <tr key={vehiculoById.id}>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.id}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.cilindraje}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.color}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.marca}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.modelo}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.siniestros}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.placa}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.descripcion}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.activo ? "Sí" : "No"}</td>
                  <td className="border-b border-color2 px-2 sm:px-4 py-2 text-center">{vehiculoById.poliza}</td>
